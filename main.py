...
Exemples :
    ...
    python main.py ingest data/rapport.pdf # indexe un seul fichier
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_ingest = sub.add_parser("ingest", help="Indexer un PDF ou un dossier de PDF.")
...
def main() -> int:
    ...
    if args.command == "ingest":
        if args.path.is_dir():
            ...
            if not results:
                print(f"Aucun PDF trouvé dans {args.path}.")
